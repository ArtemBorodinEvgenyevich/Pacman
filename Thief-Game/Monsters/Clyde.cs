...
{
    public class Clyde: Monster
    {
        /// <summary>
        /// Create Clyde (monster, orange)
        /// </summary>
        /// <param name="startX">Start position X</param>
        /// <param name="startY">Start position Y</param>
        /// <param name="speed">Speen [obstacle]</param>
        public Clyde(int startX, int startY, int speed): base(startX, startY, speed, @"Clyde.png")
        {

        }

        /// <summary>
        /// Move Clyde to target
        /// </summary>
